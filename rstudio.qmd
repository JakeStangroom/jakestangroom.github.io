...
1.  **Install the Latest Version of R**\
    ...
    ***IMPORTANT:*** Ensure you update to the latest version before starting this course—even if R is already installed—as older versions may cause unexpected issues when using newer `R` packages (like this [^rstudio-1])
...
[^rstudio-1]: The packages we ask you to install are usually *easy* to install, so if you have errors like this, it might be because your `R` is out of date:
